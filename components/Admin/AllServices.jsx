...
import { getAllAdminServices, deleteAdminService } from "../../redux/actions/serviceAction";
            ...
            {services &&
              services.map((service) => (
                <DataTable.Row key={service._id}>
                  ...
                  <DataTable.Cell style={{ width: 20 }} onPress={() => navigation.navigate("updateservice", { id: service._id })}>
                    <Text style={styles.text}>Edit</Text>
                  </DataTable.Cell>
                  <DataTable.Cell style={{ width: 20 }} onPress={() => dispatch(deleteAdminService(service._id))}>
                    <Text style={styles.text}>Delete</Text>
                  </DataTable.Cell>
                </DataTable.Row>
              ))}
